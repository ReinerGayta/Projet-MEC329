...
hMax=0;       %"Hauteur maximale de la grue";
hM=0;     %"Hauteur cible de la charge";
W=0;      %"Charge de 6000 Newtons";
teta1=0;     %"Inclinaison maximale du bras inferieur par rapport au sol";
teta2=0;     %"Inclinaison maximale du  bras superieur par rapport au sol";
OB=0;     %"Longueur du verin inferieur";
CE=0;    %"Longueur du verin superieur";
alpha1=0;    %"Angle entre le verin OB et l'axe horizontal";
alpha2=0;     %"Angle entre le verin CE et l'axe horizontal";
Fs=0;     %"Facteur de securite";
